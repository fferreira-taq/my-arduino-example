...
class ESP8266WIFI {
  private:
    ...
    boolean TimeOut(int timeout, String target);
  ...
  public:
    ...
    */
    ESP8266WIFI();
    void init(HardwareSerial  *uart, int baud = 115200, int pinCH = 53);
    /**
    ...
    */
    boolean createAP(String ssid, String pwd, int channel, int sec);
